            ...
            <div class="options-container">
                ...
                <nav class="views-container">
                    ...
                    <router-link to="/dashboard/events" class="menu-button"
                        ...
                        <svg width="45" height="45" viewBox="0 0 30 33" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path
                    ...
                    <router-link v-if="userRole == 'administrador'" to="/dashboard/users" class="menu-button"
                        ...
                        <svg width="45" height="45" viewBox="0 0 35 21" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path
                    ...
                    <router-link to="/dashboard/settings" class="menu-button"
                        ...
                        <svg width="50" height="50" viewBox="0 0 29 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path
        ...
        <div class="main-content">
            ...
            <div class="info-user-container">
                ...
                <div class="widgets-info-container">
                    ...
                    <WidgetDataNew
                 v-for="widget, i, in WidgetInfoUserArray" :key="i" :url="widget.url"
                        :data="widget.data" :color="widget.color" :name="widget.name" />

                    <!-- Widget for user icon and name -->
                    <WidgetUserName
                        :url="`https://res.cloudinary.com/dimcnbuqs/image/upload/v1708482405/Vector_4_saaici.png`"
                        :name="`iconName`" :nameUser="userName" />
                </div>
            </div>
...
import WidgetDataNew from '@/components/dashboard/WidgetDataNew.vue';
import WidgetUserName from '@/components/dashboard/WidgetUserName.vue';
...
// DEFINICIÓN DE ARREGLO USADO PARA LLENAR DATOS DE LOS WIDGETS
const WidgetInfoUserArray: Array<WidgetInfo> = [
    {
        url: "https://res.cloudinary.com/dimcnbuqs/image/upload/v1708482404/Vector_2_s6mnwk.png",
        data: "5",
        color: "27AB90",
        name: "iconPhone"
    },
    {
        url: "https://res.cloudinary.com/dimcnbuqs/image/upload/v1708482404/Vector_3_qm18sd.png",
        data: "4",
        color: "FF433D",
        name: "iconMessage"
    }
